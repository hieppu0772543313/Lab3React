...
export default function ProfileAllUser({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <View style={[{flex: 1, backgroundColor: '#009966'}, styles.avatar]}>
        <Avatar.Image
          style={{
            height: 154,
            width: 154,
      ...
      <View style={styles.containerInfo}>
        <View style={styles.viewTxt}>
          <Icon source="account" size={30} color="#009966" />
          <Text style={styles.txt}>User Name: </Text>
          <Text style={styles.txtInfo}>{fullname}</Text>
        </View>
        <View style={styles.viewTxt}>
          <Icon source="email" size={30} color="#009966" />
          <Text style={styles.txt}>Email: </Text>
          <Text style={styles.txtInfo}>{email}</Text>
        </View>
        <View style={styles.viewTxt}>
          <Icon source="phone" size={30} color="#009966" />
