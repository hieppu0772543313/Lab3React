...
const PasswordToggleIcon = ({ showPassword, onPress }) => {
    return (
      <TextInput.Icon
...
const Login = ({ navigation }) => {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', margin: 10, borderRadius: 20 }}>
            <Text style={{ color: 'darkgreen', fontSize: 30, fontWeight: 'bold', alignSelf: 'center' }}>Xin chào </Text>
            ...
            <TextInput
                ...
                right={<PasswordToggleIcon showPassword={showPassword} onPress={toggleShowPassword} />}
